...
--
-- Table structure for table `DATEFR`
--

DROP TABLE IF EXISTS `DATEFR`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `DATEFR` (
...
--
-- Dumping data for table `DATEFR`
--

LOCK TABLES `DATEFR` WRITE;
/*!40000 ALTER TABLE `DATEFR` DISABLE KEYS */;
INSERT INTO `DATEFR` VALUES ('2001-01-00'),('2003-03-01'),('2004-05-02'),('2008-02-10'),('2014-01-05'),('2014-01-20'),('2014-02-20'),('2014-03-02'),('2014-03-03'),('2014-03-12'),('2014-04-04');
/*!40000 ALTER TABLE `DATEFR` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `OFFRIR` VALUES ('a17',3,'AMOX45',100),('a17',4,'3MYC7',500),('a55',1,'CLAZER6',50),('a93',5,'CLAZER6',150),('b25',6,'CLAZER6',950),('c3',7,'CLAZER6',450),('e5',8,'CLAZER6',520),('e5',11,'CLAZER6',520),('k4',10,'CLAZER6',450),('p7',9,'CLAZER6',450);
...
CREATE TABLE `RAPPORT_VISITE` (
  ...
  `RAP_DATE` date NOT NULL DEFAULT '0000-00-00',
  `RAP_BILAN` varchar(510) DEFAULT '',
  `RAP_MOTIF` varchar(510) DEFAULT '',
  `RAP_COEFCONFIANCE` int(11) DEFAULT '0',
  `RAP_ETAT` tinyint(1) DEFAULT '0',
  `RAP_DATEREDAC` date DEFAULT '0000-00-00',
...
INSERT INTO `RAPPORT_VISITE` VALUES ('a17',3,2,'2000-01-01','Plutôt satisfaisant.','Grippe',5,0,'2016-10-04'),('a17',4,1,'2016-09-25','Bilan test','Motif test',1,0,'2016-10-06'),('a55',1,16,'2006-05-18','Est-ce une blague ? ','Diarrhée',6,0,'2016-10-04'),('a93',5,6,'2004-08-25','Autant prendre un doliprane','Angine',8,0,'2016-10-04'),('b25',6,8,'2011-03-11','Efficace, mais goût dégueu ! ','Toux',9,0,'2016-10-04'),('c3',7,10,'2010-07-13','Aucun effet','Angine',4,0,'2016-10-04'),('e5',8,15,'2001-12-22','Beaucoup trop dangereux','Hypo-Glycémie',2,0,'2016-10-04'),('e5',11,20,'2001-12-19','Sent pas bon...','Hypo-Glycémie',3,0,'2016-10-04'),('k4',10,8,'2013-07-17','Aucun effet','Angine',1,0,'2016-10-04'),('n58',15,10,'2000-01-14','Aucun effet','Angine',4,1,'2016-10-04'),('p49',16,8,'2000-01-25','Aucun effet','Angine',5,0,'2016-10-04'),('p49',18,20,'2000-01-19','Sent pas bon...','Hypo-Glycémie',7,0,'2016-10-04'),('p49',19,10,'2000-01-13','Aucun effet','Angine',8,0,'2016-10-04'),('p49',20,8,'2000-01-25','Aucun effet','Angine',2,0,'2016-10-04'),('p49',21,15,'2000-01-22','Beaucoup trop dangereux','Hypo-Glycémie',1,0,'2016-10-04'),('p7',9,8,'2016-07-13','Aucun effet','Angine',7,0,'2016-10-04'),('t60',17,15,'2000-01-22','Beaucoup trop dangereux','Hypo-Glycémie',6,0,'2016-10-04');
...
CREATE TABLE `TRAVAILLER` (
  ...
  KEY `FK_TRAVAILLER_DATEFR` (`JJMMAA`),
  CONSTRAINT `FK_TRAVAILLER_DATEFR` FOREIGN KEY (`JJMMAA`) REFERENCES `DATEFR` (`JJMMAA`),
...
-- Dump completed on 2017-05-02 14:40:37
